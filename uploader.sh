...
curl -s -X POST --data-urlencode data@/tmp/measurements --data-urlencode picture@/tmp/pict.jpg http://phytonat/measurements > /tmp/response && rm /tmp/measurements /tmp/pict.jpg
